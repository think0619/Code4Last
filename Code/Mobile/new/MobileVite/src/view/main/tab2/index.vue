<template>
    ...
    <div class="btnArea" id="btnArea">
        <van-space direction="vertical" fill size="2vh">
            ...
            <div id="page2_btn5" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn5')">
                <span class="btn_name">智慧园区5</span>
                <van-image round class="crtIcon" fit="cover" :src="correcticon" v-show="showlist.page2_btn5" />
            </div>
            <div id="page2_btn6" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn6')">
                <span class="btn_name">智慧园区6</span>
                <van-image round class="crtIcon" fit="cover" :src="correcticon" v-show="showlist.page2_btn6" />
            </div>
            <div id="page2_btn7" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn7')">
                <span class="btn_name">智慧园区7</span>
                <van-image round class="crtIcon" fit="cover" :src="correcticon" v-show="showlist.page2_btn7" />
            </div>
            <div id="page2_btn8" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn8')">
                <span class="btn_name">智慧园区8</span>
                <van-image round class="crtIcon" fit="cover" :src="correcticon" v-show="showlist.page2_btn8" />
            </div>
            <div id="page2_btn9" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn9')">
                <span class="btn_name">智慧园区9</span>
                <van-image round class="crtIcon" fit="cover" :src="correcticon" v-show="showlist.page2_btn9" />
            </div>
            <div id="page2_btn10" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn10')">
                <span class="btn_name">智慧园区10</span>
                <van-image round class="crtIcon" fit="cover" :src="correcticon" v-show="showlist.page2_btn10" />
            </div>
            <div id="page2_btn11" class="cmdCustomBtn1 cmdbtn1-4" @click="onClickCmdBtn('page2_btn11')">
                <span class="btn_name">智慧园区11</span>
...
export default {
    ...
    data() {
        return {
            ...
            curBtnIndex: -1,
            // scrolltop:0,
            pageBtnArrayKey: ['page2_btn1', 'page2_btn2', 'page2_btn3', 'page2_btn4',
                'page2_btn5', 'page2_btn6', 'page2_btn7', 'page2_btn8',
                'page2_btn9', 'page2_btn10', 'page2_btn11',
            ],
            showlist: {
                page2_btn1: false,
                page2_btn2: false,
