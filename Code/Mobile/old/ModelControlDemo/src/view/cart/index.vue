<template>
  ...
  <div class="viewcontain">
    ...
    <van-grid column-num="3">
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_01')">打开 01</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_01')">关闭 01</van-button>
      </van-grid-item>
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_02')">打开 02</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_02')">关闭 02</van-button>
      </van-grid-item> 
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_03')">打开 03</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_03')">关闭 03</van-button>
      </van-grid-item> 
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_04')">打开 04</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_04')">关闭 04</van-button>
      </van-grid-item> 
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_05')">打开 05</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_05')">关闭 05</van-button>
      </van-grid-item> 
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_06')">打开 06</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_06')">关闭 06</van-button>
      </van-grid-item>
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_07')">打开 07</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_07')">关闭 07</van-button>
      </van-grid-item>
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_08')">打开 08</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_08')">关闭 08</van-button>
      </van-grid-item>
      ...
      <van-grid-item>
        <van-button type="primary" @click="clickSwitchBtn(1, 'swopen_09')">全&emsp;&nbsp;开</van-button>
      </van-grid-item>
      <van-grid-item>
        <van-button type="warning" @click="clickSwitchBtn(0, 'swclose_09')">全&emsp;&nbsp;关</van-button>
      </van-grid-item>
