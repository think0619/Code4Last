<template>
  <div class="drag" ref="dragDiv">
    ...
    <div
      ref="moveDiv"
      @mousedown="mouseDownFn" @touchstart="mouseDownFn"
  ...
  methods: {
    ...
    mouseDownFn: function (e) {
      if (!this.confirmSuccess) {
        ...
        this.beginClientX = e.clientX?e.clientX:e.changedTouches[0].clientX;
    ...
    mouseMoveFn(e) {
      if (this.mouseMoveState) {
        let numX=e.clientX?e.clientX:e.changedTouches[0].clientX
        let width =  numX - this.beginClientX;
    ...
    moseUpFn(e) {
      ...
      let numX=e.clientX?e.clientX:e.changedTouches[0].clientX
      var width =  numX- this.beginClientX;
